function updateCountdown() {
    ...
    var newYear = new Date(now.getFullYear() + 1, 0, 1); // Дата и время Нового года следующего года
    ...
    document.getElementById('countdown').innerHTML = daysText + " " + hoursText + " " + minutesText + " " + secondsText;
}
